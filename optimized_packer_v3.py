"""
OPTIMIZED PACKER v3 - Multi-Trial Best Selection
=================================================
5 trials per group, keeps best. Target: beat 166.
"""
...
TRIALS_PER_GROUP = 5  # Increase for better results (slower)
...
def pack_best_of_trials(n, trials=TRIALS_PER_GROUP):
...
def main():
    print("\n" + "=" * 60)
    print(f"⚡ OPTIMIZED PACKER v3 - {TRIALS_PER_GROUP} Trials Per Group")
    print("=" * 60)
    ...
    pd.DataFrame(rows).to_csv('submission_optimized_v3.csv', index=False)
    print(f"\n📄 Saved: submission_optimized_v3.csv")
